                    ...
                    <div className="row">
                      <div className="col-md-12 pl-md-0">
                        <div className="auth-form-wrapper px-4 py-5 ">
                          ...
                          {error &&
                            <div className="alert alert-danger text-center">invalid credeentials</div>
                          }
                              ...
                              <div className="input-group">
                                ...
                                <div className="input-group-append">
                                  <span className="input-group-text" onClick={() => {
                                    ...
                                    {!visiblePassword && (<i className="fa fa-eye"></i>)}
                                    {visiblePassword && (<i className="fa fa-eye-slash"></i>)}
                                  </span>
                                </div>
                              </div>
                            </div>
