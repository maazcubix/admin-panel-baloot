    ...
    <div>
          <div className="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            ...
            <div>
                ...
                <button className="btn btn-success p-3" onClick={() => sendEmail1()}>Send Email </button>
                {/* <Link to="/add-avatar" className="btn btn-success p-3">Add Avatar</Link> */}
            </div>
            <div className="datatable-doc-demo">
            <div className="card">
            <DataTable value={products} tableStyle={{ minWidth: '70rem' }}>
                <Column field="code" header="Full Name" sortable style={{ width: '25%' }}></Column>
                <Column field="name" header="Name" sortable style={{ width: '25%' }}></Column>
                <Column field="category" header="Email  " sortable style={{ width: '25%' }}></Column>
